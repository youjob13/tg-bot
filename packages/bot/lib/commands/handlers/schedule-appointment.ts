import { ADMIN_ID, ADMIN_ID_2 } from '@ann-nails/config';
import {
    messagesToUsersCollection,
    requestCollection,
    scheduleCollection,
    servicesCollection,
    userCurrentRequestState,
} from '@ann-nails/db';
import * as DTO from '@ann-nails/dto';
import { botLogger } from '@ann-nails/logger';
import { formatToDate, formatToTimestamp } from '@ann-nails/shared';
import { Composer, Context } from 'grammy';
import { Chat } from 'grammy/types';

import bot, { calendar } from '../../bot.js';
import { getUserFullName, getUsernameLink } from '../../helpers.js';
import { InlineQuery } from '../../keyboards/constants.js';
import { createInlineKeyboard, makeInlineQueriesWithOptions } from '../../keyboards/utils.js';
